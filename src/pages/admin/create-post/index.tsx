...
import { cn, formatDate, getImage } from "@/lib/utils"
...
const CreatePost = observer(() => {
    const handleCaptureClick = async () => {
        ...
        const canvas1 = await html2canvas(slide1Element);
            ...
            {!itemsInitialized ? (
                ...
                <>
                    <div className='grid w-full grid-cols-1 gap-4'>
                        {items
                            .map((i) => (
                                <div className='flex flex-row' key={i.id}>
                                    <Card className='w-full aspect-square slide1'>
                                        ...
                                        <div className='absolute'>
                                            <CardHeader className='flex flex-row justify-between bg-transparent'>
                                                <div>
                                                    <CardTitle className=''>
                                                        {i.name}
                                                    </CardTitle>
                                    ...
                                    <Card className='w-full aspect-square slide2'>
